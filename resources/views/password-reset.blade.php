                ...
                <form action="{{ route('pass.update') }}" method="POST" data-parsley-validate="" novalidate="">
                    ...
                    <div class="text-center">
                        ...
                        <div class="input-group mt-4">
                            <input type="password" class="form-control p-4 border-0 bg-light" name="passwordLogIn" id="resetPassword" placeholder="Enter your new password" required="">
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary toggle-password" type="button">
                                    <i class="fa fa-eye" id="toggleResetPasswordIcon"></i>
                                </button>
                            </div>
                        </div>
...
<script>
    $(document).on('click', '.toggle-password', function() {
        ...
        let icon = $('#toggleResetPasswordIcon');
